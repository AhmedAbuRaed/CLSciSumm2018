...
public class IDOutputInstances {
    public static void main(String args[]) {
        if (args.length > 0) {
            ...
            String updaterString = args[8];
            String[] targetOptions = args[9].split("\\_");
            ...
            for (String cluster : targetClusters) {
                ...
                File matchOutputW2V = new File(workingDir + File.separator + "IO" + File.separator + cluster + "_MatchTesting_output_" + minTokenLimit + "_" + maxTokenLimit + "_" + tokensLimitCount + "_" + learningRate + "_" + updaterString + "_" + nFilters + "_" + nEpochs + ".csv");
                File facetOutputW2V = new File(workingDir + File.separator + "IO" + File.separator + cluster + "_FacetTesting_output_" + minTokenLimit + "_" + maxTokenLimit + "_" + tokensLimitCount + "_" + learningRate + "_" + updaterString + "_" + nFilters + "_" + nEpochs + ".csv");
                ...
                try {
                    ...
                    while (/*((lineinput1 = brinput1.readLine()) != null) && */((lineinput2 = brinput2.readLine()) != null) && ((lineinput3 = brinput3.readLine()) != null) &&
                        ...
                        pwMatch.println(lineinput2.split(",")[0] + "," + matchLineoutput);
                        pwMatch.flush();
                        pwMatch.close();

                        PrintWriter pwFacet = new PrintWriter(new FileWriter(idFacetOutputW2V, true));
                        pwFacet.println(lineinput2.split(",")[0] + "," + facetLineOutput);
                        pwFacet.flush();
                        pwFacet.close();
                    }
