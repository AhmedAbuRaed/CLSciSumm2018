...
public class PreProcessTrainingIO {
    ...
    public static void main(String args[]) throws Exception {
        if (args.length > 0) {
            ...
            miniBatchSize = Integer.parseInt(args[5]);

            File matchInput1W2V = new File(workingDir + File.separator + "IO" + File.separator + "MatchTraining_input1_" + minTokenLimit + "_" + maxTokenLimit + "_" + tokensLimitCount + "_" + negativeRatio + ".csv");
            File matchInput2W2V = new File(workingDir + File.separator + "IO" + File.separator + "MatchTraining_input2_" + minTokenLimit + "_" + maxTokenLimit + "_" + tokensLimitCount + "_" + negativeRatio + ".csv");
            File matchInput3W2V = new File(workingDir + File.separator + "IO" + File.separator + "MatchTraining_input3_" + minTokenLimit + "_" + maxTokenLimit + "_" + tokensLimitCount + "_" + negativeRatio + ".csv");
            File matchOutputW2V = new File(workingDir + File.separator + "IO" + File.separator + "MatchTraining_output_" + minTokenLimit + "_" + maxTokenLimit + "_" + tokensLimitCount + "_" + negativeRatio + ".csv");

            File facetInput1W2V = new File(workingDir + File.separator + "IO" + File.separator + "FacetTraining_input1_" + minTokenLimit + "_" + maxTokenLimit + "_" + tokensLimitCount + ".csv");
            File facetInput2W2V = new File(workingDir + File.separator + "IO" + File.separator + "FacetTraining_input2_" + minTokenLimit + "_" + maxTokenLimit + "_" + tokensLimitCount +".csv");
            File facetInput3W2V = new File(workingDir + File.separator + "IO" + File.separator + "FacetTraining_input3_" + minTokenLimit + "_" + maxTokenLimit + "_" + tokensLimitCount +".csv");
            File facetOutputW2V = new File(workingDir + File.separator + "IO" + File.separator + "FacetTraining_output_" + minTokenLimit + "_" + maxTokenLimit + "_" + tokensLimitCount +".csv");
            ...
            try {
                matchTrainingMultiDataSetIterator = Utilities.getTrainingRecordReaderMultiDataSetIterator(matchInput1W2V.getPath(), matchInput2W2V.getPath(), matchInput3W2V.getPath(), matchOutputW2V.getPath(), 2, totalRow, miniBatchSize);
                int i = 0;
                while (matchTrainingMultiDataSetIterator.hasNext()) {
                    MultiDataSet multiDataSet = matchTrainingMultiDataSetIterator.next();
                    multiDataSet.save(new File(workingDir + File.separator + "IO" + File.separator + "MatchMultiDataSetFiles" + File.separator + "TrainingMultiDataSet_" + minTokenLimit + "_" + maxTokenLimit + "_" + negativeRatio + "_" + miniBatchSize + "_" + i + ".bin"));
                    i++;
                }
            } catch (IOException e) {
                e.printStackTrace();
            ...
            try {
                ...
                while (facetTrainingMultiDataSetIterator.hasNext()) {
                    ...
                    multiDataSet.save(new File(workingDir + File.separator + "IO" + File.separator + "FacetMultiDataSetFiles" + File.separator + "TrainingMultiDataSet_" + minTokenLimit + "_" + maxTokenLimit + "_" + miniBatchSize + "_" + i + ".bin"));
                    i++;
                }
            } catch (IOException e) {
                e.printStackTrace();
