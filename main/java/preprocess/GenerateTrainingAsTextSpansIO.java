...
public class GenerateTrainingAsTextSpansIO {
    public static void main(String args[]) {
        if (args.length > 0) {
            ...
            File matchInput1 = new File(workingDir + File.separator + "MatchTraining_input1_" + minTokenLimit + "_" + maxTokenLimit + "_" + tokensLimitCount + "_" + negativeRatio + ".csv");
            File matchInput2 = new File(workingDir + File.separator + "MatchTraining_input2_" + minTokenLimit + "_" + maxTokenLimit + "_" + tokensLimitCount + "_" + negativeRatio + ".csv");
            File matchInput3 = new File(workingDir + File.separator + "MatchTraining_input3_" + minTokenLimit + "_" + maxTokenLimit + "_" + tokensLimitCount + "_" + negativeRatio + ".csv");
            File matchOutput = new File(workingDir + File.separator + "MatchTraining_output_" + minTokenLimit + "_" + maxTokenLimit + "_" + tokensLimitCount + "_" + negativeRatio + ".csv");

            File facetInput1 = new File(workingDir + File.separator + "FacetTraining_input1_" + minTokenLimit + "_" + maxTokenLimit + "_" + tokensLimitCount + "_" + ".csv");
            File facetInput2 = new File(workingDir + File.separator + "FacetTraining_input2_" + minTokenLimit + "_" + maxTokenLimit + "_" + tokensLimitCount + "_" + ".csv");
            File facetInput3 = new File(workingDir + File.separator + "FacetTraining_input3_" + minTokenLimit + "_" + maxTokenLimit + "_" + tokensLimitCount + "_" + ".csv");
            File facetOutput = new File(workingDir + File.separator + "FacetTraining_output_" + minTokenLimit + "_" + maxTokenLimit + "_" + tokensLimitCount + "_" + ".csv");
            ...
            for (File clusterFolder : trainingXMLDatasetPath.listFiles()) {
                ...
                try {
                    Document refDocument = Factory.newDocument(new URL("file:///" + inputFolder.getPath() + File.separator + clusterFolder.getName() + ".xml"));
                    ...
                    for (File file : inputFolder.listFiles()) {
                        if (!file.getName().substring(0, file.getName().indexOf(".")).equals(clusterFolder.getName())) {
                            ...
                            for (Annotation citCitation : citCitations) {
                                ...
                                for (Annotation refpositiveInstance : refpositiveInstances) {
                                    ...
                                    long refPositiveStartOffset = refpositiveInstance.getStartNode().getOffset() - /*this is a hack to increase context*/ 50l;
                                    long refPositiveEndOffset = refpositiveInstance.getEndNode().getOffset() + /*this is a hack to increase context*/ 150l;

                                    if (refPositiveStartOffset < 0)
                                        refPositiveStartOffset = 0;

                                    if (refPositiveEndOffset > refDocument.getContent().size())
                                        refPositiveEndOffset = refDocument.getContent().size();

                                    List<Annotation> refSentenceWordTokens = refWordTokens.get(refPositiveStartOffset, refPositiveEndOffset).inDocumentOrder();
                                    List<Annotation> refSentenceBNEntities = refSentencesBNEntities.get(refPositiveStartOffset, refPositiveEndOffset).inDocumentOrder();
                                    ...
                                    TrainingExample trainingExample = new TrainingExample(Pair.of(filteredCitStartOffset, filteredCitEndOffset),
                                            Pair.of(refpositiveInstance.getStartNode().getOffset(), refPositiveEndOffset));
                                ...
                                for (Annotation refSentence : refFilteredSentences) {
                                    ...
                                    Utilities.append2CSVFile(count + "_" + refSentence.getFeatures().get("sid").toString() + "_" + clusterFolder.getName() + "_" +
                                            citCitation.getFeatures().get("Citing_Article").toString() + "_" + citCitation.getFeatures().get("Citation_Offset").toString() + "," +
                                            citCitationACLCSVString.toString() + "," + citCitationBNCSVString.toString() + "," + citCitationGNCSVString.toString(), matchInput1);
                                    Utilities.append2CSVFile(count + "_" + refSentence.getFeatures().get("sid").toString() + "_" + clusterFolder.getName() + "_" +
                                            citCitation.getFeatures().get("Citing_Article").toString() + "_" + citCitation.getFeatures().get("Citation_Offset").toString() + "," +
